...
import { calculateWinner, getBestMove } from "@/app/utils/utils";
    ...
    <>
      ...
      <span className="flex justify-center mt-5 select-none">
        {(winner || isDraw) && (
          ...
          <button
            className="py-2 px-4 text-white rounded select-none bg-zinc-800 absolute hover:bg-zinc-900 transition duration-300"
